        ...
        <div className="row">
            ...
            <div className="col-md-6">
                <div className="product p-4" style={{ marginTop: "4em" }}>
                    ...
                    <div className="cart mt-4 align-items-center" style={{ color: "white" }}> <button className="btn text-uppercase mr-2 px-4" style={{color: "white", backgroundColor: "black" }} onClick={(e) => {
                        e.preventDefault();
